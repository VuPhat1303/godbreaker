...
<body>
    ...
    <div class="khoitieude text-xs-center">
        ...
        <nav class="breadcrumb">
            <a href="home.html">Home</a> &nbsp; / &nbsp; <a href="#">Men</a>
        </nav>
    </div>
        ...
        <div class="row">
            <div class="col-sm-4">
                <div class="motspchuan">
                    <a class="duoi">
                        <img src="images/jpg41.jpg" alt="">
                        <p class="price_prod">
                            <span class="price">350000</span>
                        </p>
                        <span style="font-weight: bolder;"> BoomerBreaker Nam </span>
            ...
            <div class=" col-sm-4 ">
                <div class="motspchuan ">
                    <a class="duoi ">
                        <img src="images/jpg100.jpg " alt=" ">
                        <p class="price_prod ">
                            <span class="price ">350000</span>
                        </p>
                        <span style="font-weight: bolder;">Áo Khoác Dù Breaker Nam</span>
                        <input type="number" name="" min="1" max="10" value="1" style="border: 1px solid black;border-radius: 4px; height: 25px;  text-align: center; " ;>
                        <a  onclick="them(this)" class="checkout btn btn-warning mt-2">Thêm Vào Giỏ Hàng</a>
                    </a>
                </div>
            ...
            <div class="col-sm-4 ">
                <div class="motspchuan ">
                    <a class="duoi ">
                        <img src="images/jpg101.jpg " alt=" ">
                        <p class="price_prod ">
                            <span class="price ">250000</span>
                        </p>
                        <span style="font-weight: bolder;"> Áo Khoác White Breaker Nam</span>
                        <input type="number" name="" min="1" max="10" value="1" style="border: 1px solid black;border-radius: 4px; height: 25px;  text-align: center; " ;>
